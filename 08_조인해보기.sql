...
/*
1. loc 테이블에 loc.state_province = 'California'; 조건에 맞는 같은 대상으로
2. location_id 값과 같은 값을 가지는 데이터를 departments 에서 찾아서 조인
3. 위에 조인한 결과와 동일한 department_id를 가진 employees 테이블의 데이터를 찾아 조인
